...
#
# Answer:
# The nodes of the graph represent the different campus buildings.
# The edges represent the distance from one building to another.
# The distances are represented as the weighted edges.
